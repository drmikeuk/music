...
d3.csv('PerformanceDatabaseMock.csv').then(data => {
  ...
  composersRowChart.width(260).height(1000)
  ...
  //selectPlaces.title(function (d){return 'STATE: ' + d.key;})
  // https://stackoverflow.com/questions/51746692/change-text-and-remove-select-all-from-dc-selectmenu
